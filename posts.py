...
def newPost(url, kasutajanimi, parool, pealkiri, sisu):
    ...
    response = requests.put(url)(url, auth=(kasutajanimi, parool), headers=headers, data=json_data)
...
if __name__ == "__main__":
    ...
    url = "https://robertsoerd.webhosting.tptlive.ee/wp/wp-json/wp/v2/posts/"
